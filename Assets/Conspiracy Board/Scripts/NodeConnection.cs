...
public class NodeConnection : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        // [추가] 시작할 때 LineRenderer의 원래 Sorting Order 값을 저장
    ...
    // [추가] LineRenderer를 희미한 레이어로 보내는 함수
    ...
    // [추가] LineRenderer를 원래 레이어로 복원하는 함수
    public void RestoreToDefaultLayer()
    {
        if (lineRenderer != null)
        {
            lineRenderer.sortingOrder = originalSortingOrder;
        }
    }
}